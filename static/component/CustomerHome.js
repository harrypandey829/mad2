export default {
  ...
  <div>
    ...
    <!-- Scrollable Card Container (600px Height) -->
    <div class="row card-container mx-auto" style="height: 600px; overflow-y: auto; padding-right: 10px; background: #f9f9f9; border-radius: 12px; border: 1px solid #ddd;">
